...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.V1Session();
  });
  ...
  describe('V1Session', function() {
    it('should create an instance of V1Session', function() {
      // uncomment below and update the code to test V1Session
      //var instane = new SubspaceProductApi.V1Session();
      //expect(instance).to.be.a(SubspaceProductApi.V1Session);
    });
    ...
    it('should have the property clientIp (base name: "client_ip")', function() {
      ...
      //var instance = new SubspaceProductApi.V1Session();
      //expect(instance).to.be();
    });

    it('should have the property clientPort (base name: "client_port")', function() {
      // uncomment below and update the code to test the property clientPort
      //var instance = new SubspaceProductApi.V1Session();
      //expect(instance).to.be();
    });

    it('should have the property subspaceIp (base name: "subspace_ip")', function() {
      // uncomment below and update the code to test the property subspaceIp
      //var instance = new SubspaceProductApi.V1Session();
      //expect(instance).to.be();
    });

    it('should have the property subspacePort (base name: "subspace_port")', function() {
      // uncomment below and update the code to test the property subspacePort
      //var instance = new SubspaceProductApi.V1Session();
      //expect(instance).to.be();
    });
