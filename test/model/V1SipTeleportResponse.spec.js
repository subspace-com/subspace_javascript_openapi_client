...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.V1SipTeleportResponse();
  });
  ...
  describe('V1SipTeleportResponse', function() {
    it('should create an instance of V1SipTeleportResponse', function() {
      // uncomment below and update the code to test V1SipTeleportResponse
      //var instane = new SubspaceProductApi.V1SipTeleportResponse();
      //expect(instance).to.be.a(SubspaceProductApi.V1SipTeleportResponse);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new SubspaceProductApi.V1SipTeleportResponse();
    ...
    it('should have the property teleportEntryPoints (base name: "teleport_entry_points")', function() {
      // uncomment below and update the code to test the property teleportEntryPoints
      //var instance = new SubspaceProductApi.V1SipTeleportResponse();
      //expect(instance).to.be();
    });
