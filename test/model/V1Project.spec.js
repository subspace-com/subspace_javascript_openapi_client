...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.V1Project();
  });
  ...
  describe('V1Project', function() {
    it('should create an instance of V1Project', function() {
      ...
      //var instane = new SubspaceProductApi.V1Project();
      //expect(instance).to.be.a(SubspaceProductApi.V1Project);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new SubspaceProductApi.V1Project();
    ...
    it('should have the property acceleratorQuota (base name: "accelerator_quota")', function() {
      // uncomment below and update the code to test the property acceleratorQuota
      //var instance = new SubspaceProductApi.V1Project();
      //expect(instance).to.be();
    });

    it('should have the property acceleratorRequestPort (base name: "accelerator_request_port")', function() {
      // uncomment below and update the code to test the property acceleratorRequestPort
      //var instance = new SubspaceProductApi.V1Project();
      //expect(instance).to.be();
    });

    it('should have the property globalturnLimitGb (base name: "globalturn_limit_gb")', function() {
      // uncomment below and update the code to test the property globalturnLimitGb
      //var instance = new SubspaceProductApi.V1Project();
      //expect(instance).to.be();
    });

    it('should have the property sipteleportQuota (base name: "sipteleport_quota")', function() {
      // uncomment below and update the code to test the property sipteleportQuota
      //var instance = new SubspaceProductApi.V1Project();
      //expect(instance).to.be();
    });

    it('should have the property sipteleportCallQuota (base name: "sipteleport_call_quota")', function() {
      // uncomment below and update the code to test the property sipteleportCallQuota
      //var instance = new SubspaceProductApi.V1Project();
      //expect(instance).to.be();
    });

    it('should have the property rtpspeedLimitGb (base name: "rtpspeed_limit_gb")', function() {
      // uncomment below and update the code to test the property rtpspeedLimitGb
      //var instance = new SubspaceProductApi.V1Project();
      //expect(instance).to.be();
    });
