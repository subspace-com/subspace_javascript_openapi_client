...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.ProtobufAny();
  });
  ...
  describe('ProtobufAny', function() {
    it('should create an instance of ProtobufAny', function() {
      ...
      //var instane = new SubspaceProductApi.ProtobufAny();
      //expect(instance).to.be.a(SubspaceProductApi.ProtobufAny);
    });
    ...
    it('should have the property typeUrl (base name: "type_url")', function() {
      ...
      //var instance = new SubspaceProductApi.ProtobufAny();
