...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.V1ListProjectsResponse();
  });
  ...
  describe('V1ListProjectsResponse', function() {
    it('should create an instance of V1ListProjectsResponse', function() {
      ...
      //var instane = new SubspaceProductApi.V1ListProjectsResponse();
      //expect(instance).to.be.a(SubspaceProductApi.V1ListProjectsResponse);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new SubspaceProductApi.V1ListProjectsResponse();
