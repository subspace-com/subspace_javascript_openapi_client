...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.V1ListAcceleratorsResponse();
  });
  ...
  describe('V1ListAcceleratorsResponse', function() {
    it('should create an instance of V1ListAcceleratorsResponse', function() {
      // uncomment below and update the code to test V1ListAcceleratorsResponse
      //var instane = new SubspaceProductApi.V1ListAcceleratorsResponse();
      //expect(instance).to.be.a(SubspaceProductApi.V1ListAcceleratorsResponse);
    });
    ...
    it('should have the property accelerators (base name: "accelerators")', function() {
      ...
      //var instance = new SubspaceProductApi.V1ListAcceleratorsResponse();
