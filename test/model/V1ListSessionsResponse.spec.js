...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.V1ListSessionsResponse();
  });
  ...
  describe('V1ListSessionsResponse', function() {
    it('should create an instance of V1ListSessionsResponse', function() {
      // uncomment below and update the code to test V1ListSessionsResponse
      //var instane = new SubspaceProductApi.V1ListSessionsResponse();
      //expect(instance).to.be.a(SubspaceProductApi.V1ListSessionsResponse);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new SubspaceProductApi.V1ListSessionsResponse();
