...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.V1CreateSipTeleport();
  });
  ...
  describe('V1CreateSipTeleport', function() {
    it('should create an instance of V1CreateSipTeleport', function() {
      // uncomment below and update the code to test V1CreateSipTeleport
      //var instane = new SubspaceProductApi.V1CreateSipTeleport();
      //expect(instance).to.be.a(SubspaceProductApi.V1CreateSipTeleport);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new SubspaceProductApi.V1CreateSipTeleport();
