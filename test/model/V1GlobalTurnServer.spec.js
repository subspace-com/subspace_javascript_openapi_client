...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.V1GlobalTurnServer();
  });
  ...
  describe('V1GlobalTurnServer', function() {
    it('should create an instance of V1GlobalTurnServer', function() {
      // uncomment below and update the code to test V1GlobalTurnServer
      //var instane = new SubspaceProductApi.V1GlobalTurnServer();
      //expect(instance).to.be.a(SubspaceProductApi.V1GlobalTurnServer);
    });

    it('should have the property username (base name: "username")', function() {
      // uncomment below and update the code to test the property username
      //var instance = new SubspaceProductApi.V1GlobalTurnServer();
