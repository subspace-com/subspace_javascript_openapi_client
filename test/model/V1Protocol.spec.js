...
(function(root, factory) {
  ...
  describe('V1Protocol', function() {
    it('should create an instance of V1Protocol', function() {
      // uncomment below and update the code to test V1Protocol
      //var instane = new SubspaceProductApi.V1Protocol();
      //expect(instance).to.be.a(SubspaceProductApi.V1Protocol);
    });
