...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.V1GlobalTurnResponse();
  });
  ...
  describe('V1GlobalTurnResponse', function() {
    it('should create an instance of V1GlobalTurnResponse', function() {
      // uncomment below and update the code to test V1GlobalTurnResponse
      //var instane = new SubspaceProductApi.V1GlobalTurnResponse();
      //expect(instance).to.be.a(SubspaceProductApi.V1GlobalTurnResponse);
    });
