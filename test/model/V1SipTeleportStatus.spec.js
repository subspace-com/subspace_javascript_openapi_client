...
(function(root, factory) {
  ...
  describe('V1SipTeleportStatus', function() {
    it('should create an instance of V1SipTeleportStatus', function() {
      // uncomment below and update the code to test V1SipTeleportStatus
      //var instance = new SubspaceProductApi.V1SipTeleportStatus();
      //expect(instance).to.be.a(SubspaceProductApi.V1SipTeleportStatus);
    });
