...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.V1TeleportAddresses();
  });
  ...
  describe('V1TeleportAddresses', function() {
    it('should create an instance of V1TeleportAddresses', function() {
      // uncomment below and update the code to test V1TeleportAddresses
      //var instane = new SubspaceProductApi.V1TeleportAddresses();
      //expect(instance).to.be.a(SubspaceProductApi.V1TeleportAddresses);
    });

    it('should have the property address (base name: "address")', function() {
      // uncomment below and update the code to test the property address
      //var instance = new SubspaceProductApi.V1TeleportAddresses();
