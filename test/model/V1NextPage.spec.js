...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.V1NextPage();
  });
  ...
  describe('V1NextPage', function() {
    it('should create an instance of V1NextPage', function() {
      // uncomment below and update the code to test V1NextPage
      //var instane = new SubspaceProductApi.V1NextPage();
      //expect(instance).to.be.a(SubspaceProductApi.V1NextPage);
    });
    ...
    it('should have the property before (base name: "before")', function() {
      ...
      //var instance = new SubspaceProductApi.V1NextPage();
