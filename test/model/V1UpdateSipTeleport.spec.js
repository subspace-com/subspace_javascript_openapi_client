...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.V1UpdateSipTeleport();
  });
  ...
  describe('V1UpdateSipTeleport', function() {
    it('should create an instance of V1UpdateSipTeleport', function() {
      // uncomment below and update the code to test V1UpdateSipTeleport
      //var instane = new SubspaceProductApi.V1UpdateSipTeleport();
      //expect(instance).to.be.a(SubspaceProductApi.V1UpdateSipTeleport);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new SubspaceProductApi.V1UpdateSipTeleport();
