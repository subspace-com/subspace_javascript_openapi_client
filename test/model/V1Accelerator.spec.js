...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.V1Accelerator();
  });
  ...
  describe('V1Accelerator', function() {
    it('should create an instance of V1Accelerator', function() {
      // uncomment below and update the code to test V1Accelerator
      //var instane = new SubspaceProductApi.V1Accelerator();
      //expect(instance).to.be.a(SubspaceProductApi.V1Accelerator);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new SubspaceProductApi.V1Accelerator();
    ...
    it('should have the property subspaceIpv4 (base name: "subspace_ipv4")', function() {
      // uncomment below and update the code to test the property subspaceIpv4
      //var instance = new SubspaceProductApi.V1Accelerator();
      //expect(instance).to.be();
    });
