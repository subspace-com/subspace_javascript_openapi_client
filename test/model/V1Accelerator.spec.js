...
(function(root, factory) {
  ...
  describe('V1Accelerator', function() {
    ...
    it('should have the property subspaceIp (base name: "subspaceIp")', function() {
      // uncomment below and update the code to test the property subspaceIp
      //var instance = new SubspaceProductApi.V1Accelerator();
      //expect(instance).to.be();
    });

    it('should have the property subspaceIpv4 (base name: "subspaceIpv4")', function() {
      // uncomment below and update the code to test the property subspaceIpv4
      //var instance = new SubspaceProductApi.V1Accelerator();
      //expect(instance).to.be();
    });

    it('should have the property subspacePort (base name: "subspacePort")', function() {
