...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.Body();
  });
  ...
  describe('Body', function() {
    it('should create an instance of Body', function() {
      ...
      //var instane = new SubspaceProductApi.Body();
      //expect(instance).to.be.a(SubspaceProductApi.Body);
    });

    it('should have the property protocol (base name: "protocol")', function() {
      // uncomment below and update the code to test the property protocol
      //var instance = new SubspaceProductApi.Body();
