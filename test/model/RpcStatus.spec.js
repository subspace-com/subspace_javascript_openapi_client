...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.RpcStatus();
  });
  ...
  describe('RpcStatus', function() {
    it('should create an instance of RpcStatus', function() {
      ...
      //var instane = new SubspaceProductApi.RpcStatus();
      //expect(instance).to.be.a(SubspaceProductApi.RpcStatus);
    });

    it('should have the property code (base name: "code")', function() {
      // uncomment below and update the code to test the property code
      //var instance = new SubspaceProductApi.RpcStatus();
