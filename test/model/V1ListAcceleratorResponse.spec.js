...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.V1ListAcceleratorResponse();
  });
  ...
  describe('V1ListAcceleratorResponse', function() {
    it('should create an instance of V1ListAcceleratorResponse', function() {
      // uncomment below and update the code to test V1ListAcceleratorResponse
      //var instane = new SubspaceProductApi.V1ListAcceleratorResponse();
      //expect(instance).to.be.a(SubspaceProductApi.V1ListAcceleratorResponse);
    });

    it('should have the property data (base name: "data")', function() {
      // uncomment below and update the code to test the property data
      //var instance = new SubspaceProductApi.V1ListAcceleratorResponse();
