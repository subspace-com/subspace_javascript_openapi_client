...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.GlobalTurnServiceApi();
  });
  ...
  describe('GlobalTurnServiceApi', function() {
    describe('globalTurnServiceGetGlobalTurn', function() {
      it('should call globalTurnServiceGetGlobalTurn successfully', function(done) {
        //uncomment below and update the code to test globalTurnServiceGetGlobalTurn
        //instance.globalTurnServiceGetGlobalTurn(function(error) {
