...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.SipTeleportServiceApi();
  });
  ...
  describe('SipTeleportServiceApi', function() {
    describe('sipTeleportServiceCreate', function() {
      it('should call sipTeleportServiceCreate successfully', function(done) {
        //uncomment below and update the code to test sipTeleportServiceCreate
        //instance.sipTeleportServiceCreate(function(error) {
    ...
    describe('sipTeleportServiceDelete', function() {
      it('should call sipTeleportServiceDelete successfully', function(done) {
        //uncomment below and update the code to test sipTeleportServiceDelete
        //instance.sipTeleportServiceDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('sipTeleportServiceGet', function() {
      it('should call sipTeleportServiceGet successfully', function(done) {
        //uncomment below and update the code to test sipTeleportServiceGet
        //instance.sipTeleportServiceGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('sipTeleportServiceList', function() {
      it('should call sipTeleportServiceList successfully', function(done) {
        //uncomment below and update the code to test sipTeleportServiceList
        //instance.sipTeleportServiceList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('sipTeleportServiceUpdate', function() {
      it('should call sipTeleportServiceUpdate successfully', function(done) {
        //uncomment below and update the code to test sipTeleportServiceUpdate
        //instance.sipTeleportServiceUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
