...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.AcceleratorServiceApi();
  });
  ...
  describe('AcceleratorServiceApi', function() {
    describe('acceleratorServiceCreate', function() {
      it('should call acceleratorServiceCreate successfully', function(done) {
        //uncomment below and update the code to test acceleratorServiceCreate
        //instance.acceleratorServiceCreate(function(error) {
    ...
    describe('acceleratorServiceDelete', function() {
      it('should call acceleratorServiceDelete successfully', function(done) {
        //uncomment below and update the code to test acceleratorServiceDelete
        //instance.acceleratorServiceDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('acceleratorServiceGet', function() {
      it('should call acceleratorServiceGet successfully', function(done) {
        //uncomment below and update the code to test acceleratorServiceGet
        //instance.acceleratorServiceGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('acceleratorServiceList', function() {
      it('should call acceleratorServiceList successfully', function(done) {
        //uncomment below and update the code to test acceleratorServiceList
        //instance.acceleratorServiceList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('acceleratorServiceUpdate', function() {
      it('should call acceleratorServiceUpdate successfully', function(done) {
        //uncomment below and update the code to test acceleratorServiceUpdate
        //instance.acceleratorServiceUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
