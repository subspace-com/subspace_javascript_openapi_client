...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.ProjectServiceApi();
  });
  ...
  describe('ProjectServiceApi', function() {
    describe('projectServiceCreate', function() {
      it('should call projectServiceCreate successfully', function(done) {
        //uncomment below and update the code to test projectServiceCreate
        //instance.projectServiceCreate(function(error) {
    ...
    describe('projectServiceGet', function() {
      it('should call projectServiceGet successfully', function(done) {
        //uncomment below and update the code to test projectServiceGet
        //instance.projectServiceGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('projectServiceList', function() {
      it('should call projectServiceList successfully', function(done) {
        //uncomment below and update the code to test projectServiceList
        //instance.projectServiceList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('projectServiceUpdate', function() {
      it('should call projectServiceUpdate successfully', function(done) {
        //uncomment below and update the code to test projectServiceUpdate
        //instance.projectServiceUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
