...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SubspaceProductApi.SessionServiceApi();
  });
  ...
  describe('SessionServiceApi', function() {
    describe('sessionServiceList', function() {
      it('should call sessionServiceList successfully', function(done) {
        //uncomment below and update the code to test sessionServiceList
        //instance.sessionServiceList(function(error) {
