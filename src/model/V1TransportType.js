...
/**
* Enum class V1TransportType.
* @enum {}
* @readonly
*/
export default class V1TransportType {
    ...
    /**
    * Returns a <code>V1TransportType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/V1TransportType} The enum <code>V1TransportType</code> value.
    */
