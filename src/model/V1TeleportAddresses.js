    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('transportType')) {
                obj['transportType'] = V1TransportType.constructFromObject(data['transportType']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/V1TransportType} transportType
 */
V1TeleportAddresses.prototype['transportType'] = undefined;
