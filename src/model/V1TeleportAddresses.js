...
import V1TransportType from './V1TransportType';

/**
 * The V1TeleportAddresses model module.
 * @module model/V1TeleportAddresses
 * @version 1.0
 */
class V1TeleportAddresses {
    /**
     * Constructs a new <code>V1TeleportAddresses</code>.
     * @alias module:model/V1TeleportAddresses
     */
    constructor() { 
        
        V1TeleportAddresses.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1TeleportAddresses</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1TeleportAddresses} obj Optional instance to populate.
     * @return {module:model/V1TeleportAddresses} The populated <code>V1TeleportAddresses</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1TeleportAddresses();

            if (data.hasOwnProperty('address')) {
                obj['address'] = ApiClient.convertToType(data['address'], 'String');
            }
            if (data.hasOwnProperty('transport_type')) {
                obj['transport_type'] = V1TransportType.constructFromObject(data['transport_type']);
            }
        }
        return obj;
    }
 ...
 */
V1TeleportAddresses.prototype['address'] = undefined;

/**
 * @member {module:model/V1TransportType} transport_type
 */
V1TeleportAddresses.prototype['transport_type'] = undefined;
...
export default V1TeleportAddresses;
