...
/**
* Enum class V1SipTeleportStatus.
* @enum {}
* @readonly
*/
export default class V1SipTeleportStatus {
    ...
    /**
    * Returns a <code>V1SipTeleportStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/V1SipTeleportStatus} The enum <code>V1SipTeleportStatus</code> value.
    */
