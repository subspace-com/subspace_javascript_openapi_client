...
import V1Accelerator from './V1Accelerator';
import V1NextPage from './V1NextPage';

/**
 * The V1ListAcceleratorResponse model module.
 * @module model/V1ListAcceleratorResponse
 * @version 1.0
 */
class V1ListAcceleratorResponse {
    /**
     * Constructs a new <code>V1ListAcceleratorResponse</code>.
     * @alias module:model/V1ListAcceleratorResponse
     */
    constructor() { 
        
        V1ListAcceleratorResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1ListAcceleratorResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1ListAcceleratorResponse} obj Optional instance to populate.
     * @return {module:model/V1ListAcceleratorResponse} The populated <code>V1ListAcceleratorResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ListAcceleratorResponse();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [V1Accelerator]);
            }
...
/**
 * @member {Array.<module:model/V1Accelerator>} data
 */
V1ListAcceleratorResponse.prototype['data'] = undefined;

/**
 * @member {module:model/V1NextPage} next_page
 */
V1ListAcceleratorResponse.prototype['next_page'] = undefined;
...
export default V1ListAcceleratorResponse;
