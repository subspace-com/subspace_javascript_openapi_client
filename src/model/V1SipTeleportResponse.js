...
class V1SipTeleportResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('teleportEntryPoints')) {
                obj['teleportEntryPoints'] = ApiClient.convertToType(data['teleportEntryPoints'], [V1TeleportAddresses]);
            }
 ...
 */
V1SipTeleportResponse.prototype['dateCreated'] = undefined;

/**
 * @member {Date} dateUpdated
 */
V1SipTeleportResponse.prototype['dateUpdated'] = undefined;
...
/**
 * @member {Array.<module:model/V1TeleportAddresses>} teleportEntryPoints
 */
V1SipTeleportResponse.prototype['teleportEntryPoints'] = undefined;

/**
 * @member {Number} version
 */
V1SipTeleportResponse.prototype['version'] = undefined;
