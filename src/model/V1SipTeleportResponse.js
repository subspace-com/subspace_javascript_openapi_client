...
import V1SipTeleportStatus from './V1SipTeleportStatus';
import V1TeleportAddresses from './V1TeleportAddresses';

/**
 * The V1SipTeleportResponse model module.
 * @module model/V1SipTeleportResponse
 * @version 1.0
 */
class V1SipTeleportResponse {
    /**
     * Constructs a new <code>V1SipTeleportResponse</code>.
     * @alias module:model/V1SipTeleportResponse
     */
    constructor() { 
        
        V1SipTeleportResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1SipTeleportResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1SipTeleportResponse} obj Optional instance to populate.
     * @return {module:model/V1SipTeleportResponse} The populated <code>V1SipTeleportResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1SipTeleportResponse();
            ...
            if (data.hasOwnProperty('teleport_entry_points')) {
                obj['teleport_entry_points'] = ApiClient.convertToType(data['teleport_entry_points'], [V1TeleportAddresses]);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = V1SipTeleportStatus.constructFromObject(data['status']);
            }
 ...
 * @member {String} id
 */
V1SipTeleportResponse.prototype['id'] = undefined;

/**
 * @member {String} name
 */
V1SipTeleportResponse.prototype['name'] = undefined;

/**
 * @member {String} destination
 */
V1SipTeleportResponse.prototype['destination'] = undefined;

/**
 * @member {Array.<module:model/V1TeleportAddresses>} teleport_entry_points
 */
V1SipTeleportResponse.prototype['teleport_entry_points'] = undefined;

/**
 * @member {module:model/V1SipTeleportStatus} status
 */
V1SipTeleportResponse.prototype['status'] = undefined;

/**
 * @member {Date} date_created
 */
V1SipTeleportResponse.prototype['date_created'] = undefined;

/**
 * @member {Date} date_updated
 */
V1SipTeleportResponse.prototype['date_updated'] = undefined;
...
export default V1SipTeleportResponse;
