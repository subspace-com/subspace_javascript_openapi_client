...
/**
* Enum class V1Protocol.
* @enum {}
* @readonly
*/
export default class V1Protocol {
    ...
    /**
    * Returns a <code>V1Protocol</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/V1Protocol} The enum <code>V1Protocol</code> value.
    */
