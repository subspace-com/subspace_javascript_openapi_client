...
class Body {
     ...
     */
    constructor(name, destinationIp, destinationPort) { 
        
        Body.initialize(this, name, destinationIp, destinationPort);
    }
     ...
     */
    static initialize(obj, name, destinationIp, destinationPort) { 
        obj['name'] = name;
