...
class Body {
     ...
     * @param protocol {String} udp or tcp
     * @param name {String} Name of PacketAccelerator
     * @param destinationIp {String} Destination IP, e.g. 1.2.3.4
     * @param destinationPort {Number} Destination port, e.g. 443
     */
    constructor(protocol, name, destinationIp, destinationPort) { 
        
        Body.initialize(this, protocol, name, destinationIp, destinationPort);
    }
     ...
     */
    static initialize(obj, protocol, name, destinationIp, destinationPort) { 
        obj['protocol'] = protocol;
        obj['name'] = name;
        obj['destination_ip'] = destinationIp;
 ...
 */
Body.prototype['protocol'] = undefined;
