...
import V1SipTeleportResponse from './V1SipTeleportResponse';

/**
 * The V1ListSipTeleportResponse model module.
 * @module model/V1ListSipTeleportResponse
 * @version 1.0
 */
class V1ListSipTeleportResponse {
    /**
     * Constructs a new <code>V1ListSipTeleportResponse</code>.
     * @alias module:model/V1ListSipTeleportResponse
     */
    constructor() { 
        
        V1ListSipTeleportResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1ListSipTeleportResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1ListSipTeleportResponse} obj Optional instance to populate.
     * @return {module:model/V1ListSipTeleportResponse} The populated <code>V1ListSipTeleportResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ListSipTeleportResponse();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [V1SipTeleportResponse]);
            }
...
/**
 * @member {Array.<module:model/V1SipTeleportResponse>} data
 */
V1ListSipTeleportResponse.prototype['data'] = undefined;

/**
 * @member {module:model/V1NextPage} next_page
 */
V1ListSipTeleportResponse.prototype['next_page'] = undefined;
...
export default V1ListSipTeleportResponse;
