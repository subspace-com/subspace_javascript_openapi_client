    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('nextPage')) {
                obj['nextPage'] = V1NextPage.constructFromObject(data['nextPage']);
            }
            if (data.hasOwnProperty('sipTeleports')) {
                obj['sipTeleports'] = ApiClient.convertToType(data['sipTeleports'], [V1SipTeleportResponse]);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/V1NextPage} nextPage
 */
V1ListSipTeleportResponse.prototype['nextPage'] = undefined;

/**
 * @member {Array.<module:model/V1SipTeleportResponse>} sipTeleports
 */
V1ListSipTeleportResponse.prototype['sipTeleports'] = undefined;
