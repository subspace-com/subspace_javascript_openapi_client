...
/**
 * The V1ListAcceleratorsResponse model module.
 * @module model/V1ListAcceleratorsResponse
 * @version 1.0
 */
class V1ListAcceleratorsResponse {
    /**
     * Constructs a new <code>V1ListAcceleratorsResponse</code>.
     * @alias module:model/V1ListAcceleratorsResponse
     */
    constructor() { 
        
        V1ListAcceleratorsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1ListAcceleratorsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1ListAcceleratorsResponse} obj Optional instance to populate.
     * @return {module:model/V1ListAcceleratorsResponse} The populated <code>V1ListAcceleratorsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ListAcceleratorsResponse();

            if (data.hasOwnProperty('accelerators')) {
                obj['accelerators'] = ApiClient.convertToType(data['accelerators'], [V1Accelerator]);
            }
...
/**
 * @member {Array.<module:model/V1Accelerator>} accelerators
 */
V1ListAcceleratorsResponse.prototype['accelerators'] = undefined;

/**
 * @member {module:model/V1NextPage} nextPage
 */
V1ListAcceleratorsResponse.prototype['nextPage'] = undefined;
...
export default V1ListAcceleratorsResponse;
