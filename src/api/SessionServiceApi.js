...
* @module api/SessionServiceApi
* @version 1.0
*/
export default class SessionServiceApi {

    /**
    * Constructs a new SessionServiceApi. 
    * @alias module:api/SessionServiceApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the sessionServiceList operation.
     * @callback module:api/SessionServiceApi~sessionServiceListCallback
     ...
     * @param {module:api/SessionServiceApi~sessionServiceListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1ListSessionsResponse}
     */
    sessionServiceList(acceleratorId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'acceleratorId' is set
      if (acceleratorId === undefined || acceleratorId === null) {
        throw new Error("Missing the required parameter 'acceleratorId' when calling sessionServiceList");
      }
      ...
      return this.apiClient.callApi(
        '/v1/accelerator/{accelerator_id}/session', 'GET',
